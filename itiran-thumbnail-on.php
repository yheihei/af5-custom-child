...
<?php if( is_home() && !is_paged() ) : // トップページ(1ページ目)のみ表示 ?>
	<!-- ピックアップタグをつけた記事を一覧表示 -->
...
<div class="kanren">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		$st_infeed_count ++;
		?>
		<?php if ( stFirstpost() && ( is_front_page() || is_archive() ) && trim($GLOBALS['st_child_jet_data1']) === '' && trim($GLOBALS['st_child_jet_data3']) === '' && trim($GLOBALS['st_child_jet_data6']) === '') : ?>
		...
		<?php endif; ?>
					<dt><div class="st-c-ami"></div>
						...
						<?php if( ( !st_is_mobile() && ( stFirstpost() && trim($GLOBALS['st_child_jet_data1']) === '' && trim($GLOBALS['st_child_jet_data6']) === '' && trim($GLOBALS['st_child_jet_data3']) === '' ) ) || trim($GLOBALS['st_child_jet_data18']) === '' ): ?>
					...
					<dd>
						...
						<?php if( 
									( st_is_mobile() && stFirstpost() && trim($GLOBALS['st_child_jet_data18']) !== '' ) || 
									( stFirstpost() && trim( $GLOBALS['st_child_jet_data1'] ) !== '' && trim($GLOBALS['st_child_jet_data18']) !== '' ||
									( stFirstpost() && trim( $GLOBALS['st_child_jet_data1'] ) === '' && ( trim($GLOBALS['st_child_jet_data6']) !== '' || trim($GLOBALS['st_child_jet_data3']) !== '' ) && trim($GLOBALS['st_child_jet_data18']) !== '' ) ||
									( !stFirstpost() ) && trim($GLOBALS['st_child_jet_data18']) !== '' )
								)	: ?>
