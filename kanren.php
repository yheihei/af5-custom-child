...
<?php else : ?>
	...
	?>
		<?php if ( is_yhei_related_post_ids_meta( $current_post_id ) ) : ?>
			<h4 class="point"><span class="point-in"><?php echo esc_html( $related_posts_title ); ?></span></h4>
			<?php st_the_kanren_posts( $current_post_id ); ?>
		<?php endif; ?>
<?php endif; ?>
