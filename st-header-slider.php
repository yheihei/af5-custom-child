							...
							<div class="slider post-slider header-post-slider has-excerpt<?php echo esc_attr( $class ); ?>"
								...
								<?php while ( $cat_posts_query->have_posts() ): $cat_posts_query->the_post(); ?>
									...
									<div class="slider-item post-slide<?php echo esc_attr( $image_class ); ?>"<?php echo $dir_attr_opposite; ?>>
										...
										<div class="yh-post-slide-title">
											<p class="yh-post-slide-title__category">
												<?php 
													foreach ( $categories as $category ) : ?>
														<a href="<?php echo get_category_link( $category->term_id ); ?>"><?= $category->cat_name ?></a>
													<?php
														break; // 1カテゴリーのみ出す
													endforeach; ?>
											</p>
											<p class="yh-post-slide-title__title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></p>
										</div>
									</div>
								<?php endwhile; ?>
